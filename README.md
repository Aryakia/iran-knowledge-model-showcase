...
The private research prototype currently contains:

- an approximately **2,700-year** historical timeline
...
These counts describe the current working version and may change as the model is revised.

## Research question

How might knowledge capital and the societal capacity to develop and realize human capability evolve when education, health, institutions, trade, geography, migration, conflict, political stability, and cultural destruction interact over centuries?

The model does not assume that one factor determines the trajectory. It is designed to explore **interacting mechanisms, feedback, accumulation, disruption, and recovery**.
...
The model can represent hypotheses involving:

- education
- population health
- institutional quality and continuity
- trade and knowledge exchange
- migration and scholar movement
...
- scenario comparison
- testing whether assumptions generate plausible dynamic patterns

It is **not** intended for:

- historical ranking
- estimating national or ethnic intelligence
- causal attribution from proxy values
- point prediction of historical outcomes

A future research version would require careful calibration, sensitivity testing, uncertainty analysis, and external expert review before stronger claims could be considered.
